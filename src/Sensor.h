...
class sensor{
	...
	protected:
		...
		const int static BPM_BUFFER_SIZE = 100; // Change based on how many samples you want to average
		int32_t bpmBuffer[BPM_BUFFER_SIZE];
		int nextBPMBufferIndex = 0;
		
		const int static SPO2_BUFFER_SIZE = 100; // Change based on how many samples you want to average
